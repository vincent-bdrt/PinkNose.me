             ...
             <div class="mx-2 row section-vignettes withsubpart" id="Vignettes-Hat">
                 ...
                 <?php
                    ...
                    for ($i = 1; $i <= $C_Hat; $i++) {
                        ...
                        echo '<img loading="lazy"data-vignette-item="Hat" src="avatar-creator/images/Hat/'.$i.'/Shape/1.png" alt="Avatar Vignette" class="zindex-4"> ';
                        echo '<img loading="lazy"src="avatar-creator/UI/Base.png" alt="Avatar Vignette" class="zindex-3">';
                        echo '<img loading="lazy"data-vignette-item="Hat_Back" src="avatar-creator/images/Hat/'.$i.'/Shape_Back/1.png" alt="Avatar Vignette" class="zindex-2">';
                        echo '</div></div>';
                    }
                    ?>
             </div>
