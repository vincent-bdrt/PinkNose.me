...
<section id="Section-Makeup">
    <div class="mx-2 row section-vignettes" id="Vignettes-Makeup">
        ...
        for ($i = 1; $i <= $C_Makeup; $i++) {
            ...
            echo '<img loading="lazy"src="avatar-creator/images/Makeup/'.$i.'.png" alt="Avatar Vignette" class="zindex-1"> ';
            echo '<img loading="lazy"src="avatar-creator/images/Eyes/1.png" alt="Avatar Vignette" class="zindex-2">';
