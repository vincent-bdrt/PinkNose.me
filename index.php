...
<nav class="menu-plus">
    <ul class="menu-list">
        ...
        <li class="menu-item">
        <a class="btn btn-danger" id="Utip" href="https://utip.io/ballcutter" target="_blank">
...
<main id="content" class="m-0 h-100">
    <section class="accueil">
        ...
        <div class="d-flex justify-content-center"><a class="start">Créer un avatar</a></div><img
            src="avatar-creator/UI/background-home.png" alt="Avatars créer avec avatar creator"
        ...
        <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12 p-md-0 p-sm-2 bg-light min-vh-100" id="Zone-Gauche">
                ...
                <p class="author">by <a href="https://vincent-bod.art/" target="_blank">Vincent BODART</a>- <a
                        ...
                        id="Contact" href="https://twitter.com/Ballcutter_" target="_blank">Contact </a></p>
            </div>
